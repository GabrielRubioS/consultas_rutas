...
// --------------------------------------------------------------------------------------------------------------------- //
//primera consulta
app.post('/primeraruta/:domicilio', function (request, response) {
...
//segunda consulta
app.post('/segundaruta/:id/:peso', function (request, response) {
...
// tercera consulta
app.delete('/deleteterceraruta', function (request, response) {
    let cc = request.query.cc;
...
// cuarta consulta
app.put('/cuartaconsulta', function (request, response) {
    let cc = request.query.cc;
    let apellidos = request.body.apellidos;
...
// Quinta consulta
app.get('/quintaconsulta/:cantidad/:marca', function (request, response) {
